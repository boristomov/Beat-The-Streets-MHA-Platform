...
function Questions() {
  ...
  function nextQuestion() {
    if (iter.hasNext()) {
      ...
      window.open(window.location.href = "/analytics"); // assessment results page
    }
  }
  //Back button
    ...
    <>
      <div className="answering-questions-pages">
        ...
        <div className="content">
          ...
          <div className="numbers_holder">
            
              <div className="circle">
                <b className="number_style">{questionNum(-7)}</b>
              </div>
            
            
              <div className="circle">
                <b className="number_style">{questionNum(-6)}</b>
              </div>
            
              <div className="circle">
                <b className="number_style">{questionNum(-5)}</b>
              </div>
            
            
              <div className="circle">
                <b className="number_style">{questionNum(-4)}</b>
              </div>
            
              <div className="circle">
                <b className="number_style">{questionNum(-3)}</b>
              </div>
            
            
              <div className="circle">
                <b className="number_style">{questionNum(-2)}</b>
              </div>
            
            
              <div className="circle_medium">
                <b className="mid_numbers">{questionNum(-1)}</b>
              </div>
            
            
              <div className="circle_large">
                <b className="large_number">{questionNum(0)}</b>
              </div>
            ...
            <div id = "big_rectangle" className="big_rectangle">
              ...
              <div className="media">
                ...
                <button className="me-button" onClick={answerMe}>
                  <img className="me-button" alt="" src={MeButton} />
                </button>
                <div className="me">Me</div>
                {/* CENTRAL IMAGE */}
                <img
                  className="central_media"
                  alt="Error loading img"
                  src={Woman_seeking_psycholigist_help}
                />
                {/* NOT ME BUTTON */}
                <button className="not-me-button" onClick={answerNotMe}>
                  <img className="not-me-button" alt="" src={NotMeButton} />
                </button>
        ...
        <svg width = "100%" className="backgroundGraphic_questions" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            <linearGradient id="paint0_linear_335_116" x1="1134.5" y1="0" x2="1134.5" y2="708" gradientUnits="userSpaceOnUse">
        ...
        <div className="navigation">
          <div className="left_indicators">
            <button className="indicator_arrow_left" onClick={prevQuestion}>
              <img className="indicator_left" alt="" src={LeftArrow} />
            </button>
          ...
          <div className="right_indicators">
            <button className="indicator_arrow_right" onClick={nextQuestion}>
              <img className="indicator_right" alt="" src={RightArrow} />
            </button>
